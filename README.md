...
Users must authenticate using biometrics (Fingerprint/Face ID) to view the transaction history.

Transaction Display: 
Displays a list of transactions with amount, date, description, and type.

Transaction Sorting: 
Sort transactions by date, amount, or type.

Transaction Detail View: 
View detailed information for a selected transaction.

Amount Masking: 
Toggle between showing or hiding the transaction amounts for security.
...
6. Running on a Device or Emulator
